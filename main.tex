...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{DiD/outputs/figures/event_study_monthly.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{DiD/outputs/figures/event_study_weekly.png}
    \caption{Enter Caption}
    \label{fig:placeholder}
\end{figure}
